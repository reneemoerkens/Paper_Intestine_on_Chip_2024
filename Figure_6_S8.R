...
#Figure 6A and S8A: DE analysis between stimulation and control
...
filtered_log2FC_IFNyvscontrol <- filtered_IFNyvscontrol[filtered_IFNyvscontrol$avg_log2FC > 0.5,]
filtered_log2FC_IFNbvscontrol <- filtered_IFNbvscontrol[filtered_IFNbvscontrol$avg_log2FC > 0.5,]
filtered_log2FC_IFNyvsIFNb <- filtered_IFNyvsIFNb[filtered_IFNyvsIFNb$abs_log2FC > 0.5,]
...
#Figure 6A and S8A: DEGs upon interferon stimulation. 
...
#Select genes that can function as specific identifiers for IFNy and IFNb responding cells using above code for 'complete', 'epithelial' and 'mesenchymal/neural' DE genes
#IFNb: IFI6, IFIT1, MX1
...
#Figure S8B: Visualize all marker gene positive cells
...
#Figure 6B: generate Dimplot with IFN-responding cells colored and rest gray
